!function(e, t) {
    ...
    class n {
        constructor(e) {
            const {command: t, headers: s, body: n, binaryBody: i, escapeHeaderValues: o, skipContentLengthHeader: c} = e;
            this.command = t,
            this.headers = Object.assign({}, s || {}),
            i ? (this._binaryBody = i,
            this.isBinaryBody = !0) : (this._body = n || "",
            this.isBinaryBody = !1),
            this.escapeHeaderValues = o || !1,
        ...
        static fromRawFrame(e, t) {
            ...
            for (const o of e.headers.reverse()) {
                ...
                const c = i(o[0]);
                let r = i(o[1]);
                t && "CONNECT" !== e.command && "CONNECTED" !== e.command && (r = n.hdrValueUnEscape(r)),
                s[c] = r
            }
            return new n({
                command: e.command,
    ...
    class i {
        ...
        parseChunk(e, t=!1) {
            let s;
            if (s = "string" == typeof e ? this._encoder.encode(e) : new Uint8Array(e),
            t && 0 !== s[s.length - 1]) {
        ...
        _collectFrame(e) {
            0 !== e && 13 !== e && (10 !== e ? (this._onByte = this._collectCommand,
            this._reinjectByte(e)) : this.onIncomingPing())
        }
        _collectCommand(e) {
            if (13 !== e)
                return 10 === e ? (this._results.command = this._consumeTokenAsUTF8(),
                void (this._onByte = this._collectHeaders)) : void this._consumeByte(e)
        }
        _collectHeaders(e) {
            13 !== e && (10 !== e ? (this._onByte = this._collectHeaderKey,
            this._reinjectByte(e)) : this._setupCollectBody())
        }
        _reinjectByte(e) {
            this._onByte(e)
        }
        ...
        _collectHeaderValue(e) {
            if (13 !== e)
                return 10 === e ? (this._results.headers.push([this._headerKey, this._consumeTokenAsUTF8()]),
                this._headerKey = void 0,
                void (this._onByte = this._collectHeaders)) : void this._consumeByte(e)
        }
        _setupCollectBody() {
            const e = this._results.headers.filter((e => "content-length" === e[0]))[0];
            e ? (this._bodyBytesRemaining = parseInt(e[1], 10),
    ...
    var o, c;
    e.StompSocketState = void 0,
    (o = e.StompSocketState = e.StompSocketState || (e.StompSocketState = {}))[o.CONNECTING = 0] = "CONNECTING",
    o[o.OPEN = 1] = "OPEN",
    o[o.CLOSING = 2] = "CLOSING",
    o[o.CLOSED = 3] = "CLOSED",
    e.ActivationState = void 0,
    (c = e.ActivationState = e.ActivationState || (e.ActivationState = {}))[c.ACTIVE = 0] = "ACTIVE",
    c[c.DEACTIVATING = 1] = "DEACTIVATING",
    c[c.INACTIVE = 2] = "INACTIVE";
    class r {
        constructor(e) {
            this.versions = e
        }
    ...
    r.V1_1 = "1.1",
    r.V1_2 = "1.2",
    r.default = new r([r.V1_2, r.V1_1, r.V1_0]);
    class a {
        constructor(e, t, s) {
            this._client = e,
            this._webSocket = t,
            ...
            this._serverFrameHandlers = {
                CONNECTED: e => {
                    ...
                    this._connectedVersion === r.V1_2 && (this._escapeHeaderValues = !0),
                ...
                MESSAGE: e => {
                    const t = e.headers.subscription
                      , s = this._subscriptions[t] || this.onUnhandledMessage
                      , n = e
                      , i = this
                      , o = this._connectedVersion === r.V1_2 ? n.headers.ack : n.headers["message-id"];
                    n.ack = (e={}) => i.ack(o, t, e),
                ...
                RECEIPT: e => {
                    ...
                    t ? (t(e),
                    delete this._receiptWatchers[e.headers["receipt-id"]]) : this.onUnhandledReceipt(e)
                }
                ,
                ERROR: e => {
                    this.onStompError(e)
        ...
        _setupHeartbeat(s) {
            if (s.version !== r.V1_1 && s.version !== r.V1_2)
                return;
            if (!s["heart-beat"])
                return;
            ...
            if (0 !== this.heartbeatOutgoing && 0 !== i) {
                ...
                this._pinger = setInterval(( () => {
                    this._webSocket.readyState === e.StompSocketState.OPEN && (this._webSocket.send(t),
                    this.debug(">>> PING"))
                }
                ), s)
            }
            if (0 !== this.heartbeatIncoming && 0 !== n) {
                ...
                this._ponger = setInterval(( () => {
                    ...
                    t > 2 * e && (this.debug(`did not receive server activity for the last ${t}ms`),
        ...
        discardWebsocket() {
            var e, t;
            "function" != typeof this._webSocket.terminate && (e = this._webSocket,
            t = e => this.debug(e),
        ...
        _transmit(e) {
            const {command: t, headers: s, body: i, binaryBody: o, skipContentLengthHeader: c} = e
              , r = new n({
                command: t,
                headers: s,
                body: i,
            ...
            let a = r.serialize();
            if (this.logRawCommunication ? this.debug(`>>> ${a}`) : this.debug(`>>> ${r}`),
        ...
        dispose() {
            if (this.connected)
                ...
                this._webSocket.readyState !== e.StompSocketState.CONNECTING && this._webSocket.readyState !== e.StompSocketState.OPEN || this._closeWebsocket()
        }
        _cleanUp() {
            this._connected = !1,
        ...
        subscribe(e, t, s={}) {
            (s = Object.assign({}, s)).id || (s.id = "sub-" + this._counter++),
            s.destination = e,
            ...
            return {
                id: s.id,
                unsubscribe: e => n.unsubscribe(s.id, e)
            }
        }
        unsubscribe(e, t={}) {
            t = Object.assign({}, t),
        ...
        ack(e, t, s={}) {
            s = Object.assign({}, s),
            this._connectedVersion === r.V1_2 ? s.id = e : s["message-id"] = e,
            s.subscription = t,
            this._transmit({
                command: "ACK",
                headers: s
    ...
    class h {
        constructor(t={}) {
            ...
            this.state = e.ActivationState.INACTIVE;
            const s = () => {}
            ;
            this.debug = s,
            this.beforeConnect = s,
            this.onConnect = s,
            this.onDisconnect = s,
        ...
        activate() {
            const t = () => {
                this.active ? this.debug("Already ACTIVE, ignoring request to activate") : (this._changeState(e.ActivationState.ACTIVE),
                this._connect())
            }
            ;
            this.state === e.ActivationState.DEACTIVATING ? (this.debug("Waiting for deactivation to finish before activating"),
        ...
        async _connect() {
            if (await this.beforeConnect(),
            this._stompHandler)
                return void this.debug("There is already a stompHandler, skipping the call to connect");
            if (!this.active)
            ...
            this._stompHandler = new a(this,t,{
                ...
                onWebSocketClose: t => {
                    ...
                    this.state === e.ActivationState.DEACTIVATING && this._changeState(e.ActivationState.INACTIVE),
        ...
        async deactivate(t={}) {
            const s = t.force || !1
              , n = this.active;
            let i;
            if (this.state === e.ActivationState.INACTIVE)
                return this.debug("Already INACTIVE, nothing more to do"),
                Promise.resolve();
            if (this._changeState(e.ActivationState.DEACTIVATING),
            this._reconnector && (clearTimeout(this._reconnector),
            this._reconnector = void 0),
            !this._stompHandler || this.webSocket.readyState === e.StompSocketState.CLOSED)
                return this._changeState(e.ActivationState.INACTIVE),
                Promise.resolve();
            {
            ...
            return s ? this._stompHandler?.discardWebsocket() : n && this._disposeStompHandler(),
            i
        }
        forceDisconnect() {
        ...
        subscribe(e, t, s={}) {
            ...
            this._stompHandler.subscribe(e, t, s)
        }
        unsubscribe(e, t={}) {
            this._checkConnection(),
    ...
    class l extends h {
        constructor(e) {
            ...
            this._heartbeatInfo = new d(this),
    ...
    class m {
        ...
        static over(e) {
            let t;
            return "function" == typeof e ? t = e : (console.warn("Stomp.over did not receive a factory, auto reconnect will not work. Please see https://stomp-js.github.io/api-docs/latest/classes/Stomp.html#over"),
            t = () => e),
            new l(t)
        }
    }
    m.WebSocketClass = null,
    e.Client = h,
    e.CompatClient = l,
    e.FrameImpl = n,
    e.Parser = i,
