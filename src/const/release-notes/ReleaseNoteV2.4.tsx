...
const META_V2_4 = {
    title: 'v2.4 版本说明 - 兴汉同盟 · 博客人的朋友圈！',
    keywords: '兴汉同盟, 版本说明, v2.4',
    description: '兴汉同盟 v2.4 版本说明。'
};
...
const RELEASE_INFO_V2_4 = {
    ...
    content: (
        <>
            <Paragraph>
                兴汉同盟于 2025 年 8 月 23 日发布了 v2.4 版本！该版本在「<a href="/monthly-selected">每月精选</a>」页面新增了邮件订阅功能；对「<a href="/blogs/leileiluoluo.com">博客详情</a>」页面作了优化，优化后的数据统计模块和收录文章模块更加简洁大方。
            </Paragraph>
            ...
            <Paragraph>
                兴汉同盟前端：<a href="https://github.com/leileiluoluo/xinghantongmeng/releases/tag/v2.4" target="_blank">xinghantongmeng</a>
            </Paragraph>
            <Paragraph>
                兴汉同盟后端：<a href="https://github.com/leileiluoluo/xinghantongmeng/releases/tag/v2.4" target="_blank">xinghantongmeng</a>
            </Paragraph>
        </>
    ),
