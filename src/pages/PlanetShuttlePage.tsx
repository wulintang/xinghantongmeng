...
const meta: MetaFields = {
    title: '星球穿梭 - 兴汉同盟 · 博客人的朋友圈！',
    keywords: '星球穿梭, 兴汉同盟',
    description: '兴汉同盟星球穿梭，随机穿梭到一位博友的星球！'
};
        ...
        <>
            ...
            <div style={planetStyle}>
                ...
                <div style={marginStyle}>
                    <span style={{ fontSize: '12px' }}>Copyright © 2023-2026 <a href="https://www.xinghantongmeng.com/home" style={colorWhiteStyle}>兴汉同盟</a></span>
                </div>
            </div>
        </>
    )
