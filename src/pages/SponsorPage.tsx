...
const content: JSX.Element = (
    <>
        ...
        <Paragraph style={{ marginBottom: 16 }}>
            <Text strong>
                除了个人赞助以外，兴汉同盟还愿意承接一些跟博客或站长相关的、不影响用户体验、内容健康的广告内容，若您有合作意向，请联系：
